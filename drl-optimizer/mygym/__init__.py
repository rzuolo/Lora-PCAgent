...
register(
    id="DummyLoraCollector-v0",
    entry_point="gym.envs.classic_control:DummyLoraCollector",
...
register(
    id="LoraCollector-v0",
    entry_point="gym.envs.classic_control:LoraCollector",
    max_episode_steps=10000,
    reward_threshold=500.0,
)
...
register(
    id="LoraCollector-v1",
    entry_point="gym.envs.classic_control:LoraCollector01",
    max_episode_steps=10000,
    reward_threshold=500.0,
)

register(
    id="LoraCollector-v232",
    entry_point="gym.envs.classic_control:LoraCollector232",
    max_episode_steps=10000,
    reward_threshold=500.0,
)
register(
    id="LoraCollector-v230",
    entry_point="gym.envs.classic_control:LoraCollector230",
    max_episode_steps=10000,
    reward_threshold=500.0,
)
register(
    id="LoraCollector-v99",
    entry_point="gym.envs.classic_control:LoraCollector99",
    max_episode_steps=10000,
    reward_threshold=500.0,
)
register(
    id="LoraCollector-v120",
    entry_point="gym.envs.classic_control:LoraCollector120",
    max_episode_steps=10000,
    reward_threshold=500.0,
)
register(
...
register(
    id="LoraCollector-v110",
    entry_point="gym.envs.classic_control:LoraCollector110",
    max_episode_steps=10000,
    reward_threshold=500.0,
)
register(
    id="LoraCollector-v100",
    entry_point="gym.envs.classic_control:LoraCollector100",
    max_episode_steps=10000,
    reward_threshold=500.0,
)
register(
    id="LoraCollector-v2",
    entry_point="gym.envs.classic_control:LoraCollector02",
    max_episode_steps=10000,
    reward_threshold=500.0,
)
register(
    id="LoraCollector-v5",
    entry_point="gym.envs.classic_control:LoraCollector05",
    max_episode_steps=10000,
    reward_threshold=500.0,
)
register(
    id="LoraCollector-v4",
    entry_point="gym.envs.classic_control:LoraCollector04",
    max_episode_steps=10000,
    reward_threshold=500.0,
)
register(
    id="LoraCollector-v3",
    entry_point="gym.envs.classic_control:LoraCollector03",
    max_episode_steps=10000,
    reward_threshold=500.0,
)
