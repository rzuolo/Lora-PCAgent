...
def run_single_actor(bogus, real, head, e, environment,agent,label,memory,state,list_of_actions):
       ...
       while done != 1:
            ...
            #print("SARILHO LOG4 this is the final sate at the round # ", head, " state ",state, " env.state ", environment.state, " next-state ",next_state)                         
            if real != "real":
                agent, label = learn(e)
...
for e in range(EPISODES):
    ...
    #if ( bogus != "bogus" ):
    #print("SARILHO LOG4 episode result ", episode_result, "episodes ",e , " EnvReward ", environment.total_reward, " Keiser ", keiser  )
    

    print("LOG4 ============================================================================================================================ SAR",)
    print("LOG4 ============================================================================================================================ SAR",)
    print("SARILHO LOG4 episode", e, " episode result ", episode_result2 , " EnvReward ", env.total_reward, " Keiser ", keiser )
    print("LOG4 ============================================================================================================================ SAR",)
    for i in range(1):
        print("SARILHO LOG4  actions  ",i ," ", len(list_of_actions[i]), list_of_actions[i], " reward ", reward[i])
    print("LOG4 ============================================================================================================================ SAR",)
    for i in range(1):
        print("SARILHO LOG4  actions  ",i," ",len(list_of_actions2[i]), list_of_actions2[i], " reward ", reward2[i])
    print("LOG4 ============================================================================================================================ SAR",)

    if np.count_nonzero(env.checked) > 0:
            for i in range(len(env.checked)):
                if env.checked[i] == 0:
                    print("LOG4 SARILHO the node ",i," hasn't been visited")
